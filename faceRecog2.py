...
def recognise():
    ...
    while True:
        ...
        #voice command
        myText = " welcome " + pred + " , how are you . This is your friend robot chotu "
        SpeakText('you are ' + pred) 
        myobj = gTTS(text=myText, lang='en', slow=False)


        for fx in os.listdir("voice for face/"):
            if (fx==pred + ".mp3"):
                filePresent = 1
        ...
        if(filePresent==0):
            myobj.save("voice for face/" + pred + ".mp3")
